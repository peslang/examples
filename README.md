...
Примеры для самостоятельной сборки через [Pes.NET.Sdk](https://www.nuget.org/packages/Pes.NET.Sdk) **0.2.2** с nuget.org.  
...
| [`TotpAuth/`](TotpAuth/) | классы, TOTP, QR (NuGet QRCoder) |
